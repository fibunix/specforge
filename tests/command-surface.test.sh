...
assert_contains .specforge/skills/sf-plan/SKILL.md "REGISTRY[.]md"
...
assert_contains .specforge/skills/sf-status/SKILL.md "registry"
...
assert_contains .specforge/agents/aligner.md "REGISTRY[.]md"
