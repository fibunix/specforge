...
# Generated registry state: regenerated by sf trace / sf status; committing it
# on feature branches makes branch switching collide with regenerated copies.
grep -qxF ".specforge/REGISTRY.md" "$GITIGNORE" || echo ".specforge/REGISTRY.md" >> "$GITIGNORE"
grep -qxF ".specforge/registry.json" "$GITIGNORE" || echo ".specforge/registry.json" >> "$GITIGNORE"
