...
- SpecForge phase commands are installed as skills, not `.claude/commands/`. Side-effect commands (`sf-ship`, `sf-finalize`, `sf-test`) use `disable-model-invocation: true` so Claude cannot trigger them autonomously.
